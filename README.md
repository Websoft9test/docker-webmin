...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r webmin
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r webmin -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-webmin
cd docker-webmin
docker-compose  up -d
```
...
[Webmin Administrator Guide](https://support.websoft9.com/docs/webmin)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Webmin Enterprise Support](https://apps.websoft9.com/webmin) 
